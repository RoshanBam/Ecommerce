...
?>
  <img<?php echo"src='products/".$row["image"]."'"?> class="mr-3" alt="...">
  <div class="media-body">
   <h3 class="mt-0"><?php echo $row["product_name"]?></h3>
   <h5>Price:Rs<?php echo $row["price"]?></h5>
   <h6>Quantity:<?php echo $row["quantity"]?></h6>
   <p><?php echo $row["description"]?></p>
   <a href="#" class="btn btn-success">Buy</a>
   <a <?php echo"href=myCartData.php?id=".$row["id"].""?> class="btn btn-primary">Add to cart</a>
   </div>
 <?php }} $conn->close();?>
</div>
 </div>
